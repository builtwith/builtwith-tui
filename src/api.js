...
const ENDPOINTS = {
  ...
  lists: {
    ...
    params: [
      ...
      { name: 'COUNTRY', required: false, description: 'Comma-separated country filters (e.g. US,CA)' },
      { name: 'SINCE', required: false, description: 'Date or relative time filter (e.g. 30 days ago)' },
      { name: 'SPEND', required: false, description: 'Monthly technology spend filter (number|operator, e.g. 100|GT)' },
      { name: 'REVENUE', required: false, description: 'Estimated ecommerce sales revenue filter (e.g. 100000|GT)' },
      { name: 'EMPLOYEES', required: false, description: 'Employee count filter (e.g. 50|GTE)' },
      { name: 'SKU', required: false, description: 'Product count filter (e.g. 1000|GTE)' },
      { name: 'AIM', required: false, description: 'AI maturity filter (e.g. 50|GTE)' },
      { name: 'AIO', required: false, description: 'AI openness filter (e.g. 50|GTE)' },
      { name: 'AIR', required: false, description: 'AI readiness filter (e.g. 50|GTE)' },
      { name: 'AIV', required: false, description: 'AI visibility filter (e.g. 50|GTE)' },
  ...
  agentAuthToken: {
    ...
    description: 'Poll for Device-Code Authorization result. Returns access_token on approval. No API key required.',
